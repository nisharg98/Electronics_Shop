...
if(isset($_POST['submit']))
{
	...
	$mobile=$_POST['mobile'];
	//insert
	$sql=mysqli_query($con,"select * from seller where email='$email'");
	...
	{
		$result=mysqli_query($con,"insert into seller(fname,lname,email,password,cpassword,mobile)values('$fname','$lname','$email','$pass','$cpass','$mobile')");
		if($result)
		{
