...
function user_form()
{
	...
	else if(city.value!='' && city.value.search(/^[a-zA-Z]+$/)==-1)
	{
		document.getElementById('req_city').style.display='none';
		document.getElementById('valid_city').style.display='';
		return false;
	}
	else
	{
	...
	else if(state.value!='' && state.value.search(/^[a-zA-Z]+$/)==-1)
	{
		document.getElementById('req_state').style.display='none';
		document.getElementById('valid_state').style.display='';
		return false;
	}
	else
	{
