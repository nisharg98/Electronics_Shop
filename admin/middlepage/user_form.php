			...
			<div class="span12">
	      		...
	      		<div id="horizontal" class="widget widget-form">
					...
					<div class="widget-content">
						...
						<form class="form-horizontal" action="index.php?page=user_action" method="post" enctype="multipart/form-data" onsubmit="return user_form();">
					        <fieldset>
							  ...
							  <div class="control-group">
					            ...
					            <div class="controls">
					              <label class="radio inline">
					                <input type="radio" name="gender" id="optionsRadios1" <?php if($row['gender']=='male' || $row['gender']==''){ ?> checked="checked" <?php } ?> value="male">
					                Male
					              </label>
					              <label class="radio inline">
					                <input type="radio" name="gender" id="optionsRadios2" <?php if($row['gender']=='female'){ ?> checked="checked" <?php } ?> value="female">
					                Female
					              </label>
					            </div>
					          </div>
